...
<template>
      <div class="register">
        ...
        <router-link to="/register-pro">
            <a >Je veux m'inscrire entant que professionel</a>
        </router-link>
  ...
  methods: {
      register(e){
        ...
        if(this.isSame){
            ...
            if (this.nbError == 0 && this.isSame && this.passFormat && this.emailFormat){
